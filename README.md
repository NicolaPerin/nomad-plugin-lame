...
```sh
git clone https://github.com/nicolaperin/nomad-plugin-lame.git
cd nomad-plugin-lame
...
```sh
pip install dist/nomad-plugin-lame-0.1.0
```
...
| Name | E-mail     |
|------|------------|
| Nicola Perin | [nicolaperin1998@gmail.com](mailto:nicolaperin1998@gmail.com)
